...
export default function ModeToggle({ isNight, className = "" }: ModeToggleProps) {
  ...
  const idleBtn = isNight
    ? "rounded-lg px-2.5 py-1.5 text-xs font-semibold text-white/75 transition-[color,background-color] duration-200 hover:bg-white/[0.08] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300/80 sm:px-3 sm:text-sm"
    : "rounded-lg px-2.5 py-1.5 text-xs font-semibold text-slate-800 transition-[color,background-color] duration-200 hover:bg-white/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500/60 sm:px-3 sm:text-sm";

  const activeBtn = isNight
    ? "rounded-lg bg-white/[0.14] px-2.5 py-1.5 text-xs font-semibold text-white shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300/80 sm:px-3 sm:text-sm"
    : "rounded-lg bg-slate-950/10 px-2.5 py-1.5 text-xs font-semibold text-slate-950 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.65)] ring-1 ring-slate-900/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500/60 sm:px-3 sm:text-sm";
